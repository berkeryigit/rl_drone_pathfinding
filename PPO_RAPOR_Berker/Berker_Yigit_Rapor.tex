...
\vspace{0.8cm}
{\Huge\bfseries Kapalı Ortamda PPO ile\\[0.3cm] Lidar Tabanlı Drone Keşfi\par}
\vspace{2.5cm}
{\large Berker Yiğit\par}
{\large 220202046\par}
\vspace{1.2cm}
{\small Proje deposu:\\ \url{https://github.com/berkeryigit/rl_drone_pathfinding}\\[0.2cm]
Dal: \texttt{algo/ppo}\par}
\vfill
...
Bu projede, bir insansız hava aracının yalnızca lidar ve odometri ölçümlerini kullanarak, içinde
hareketli engeller bulunan kapalı bir binayı çarpmadan ve mümkün olduğunca geniş biçimde keşfetmesi
hedeflendi. Problem, klasik yol planlamadan farklı olarak,
