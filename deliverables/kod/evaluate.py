"""Egitilmis politikalarin DETERMINISTIK (greedy) degerlendirmesi.
...
def run_episode(model: SAC, env: Fast2DDroneExplorationEnv, ep_seed: int) -> dict:
...
def main(argv=None) -> None:
    parser = argparse.ArgumentParser(description="Deterministik politika degerlendirmesi")
    ...
    for seed in seeds:
        ...
        if model_path is None:
            ...
            continue
        model = SAC.load(str(model_path), device=_DEVICE)
